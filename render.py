...
<body>
  ...
  <script>
    ...
    function animateSplashAway(splash) {{
      ...
      // the header's logo, while the splash background fades to transparent
      // underneath it - the logo appears to glide up into its final header
      // position, instead of the splash just disappearing and the header
      // logo separately appearing in a different spot.
